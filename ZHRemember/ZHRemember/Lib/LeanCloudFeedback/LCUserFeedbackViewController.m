...
- (UITableView *)tableView {
    if (_tableView == nil) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, CGRectGetWidth(self.view.frame), CGRectGetHeight(self.view.frame) - kInputViewHeight - ZHNavbarHeight)
...
- (UIButton *)addImageButton {
    if (_addImageButton == nil) {
        _addImageButton = [[UIButton alloc] initWithFrame:CGRectMake(0, CGRectGetHeight(self.view.frame) - kInputViewHeight - ZHNavbarHeight, kAddImageButtonWidth, kInputViewHeight)];
...
- (UIButton *)sendButton {
    if (_sendButton == nil) {
        ...
        _sendButton.frame = CGRectMake(CGRectGetWidth(self.view.frame) - kSendButtonWidth, CGRectGetHeight(self.view.frame) - kInputViewHeight - ZHNavbarHeight, kSendButtonWidth, kInputViewHeight);
